...
vector<int> Hidemaru::THm::TFile::getEncodingList()
{
	vector<int> ret = {
		0,      // Unknown
...
int Hidemaru::THm::TFile::getMsCodePageFromHmEncode(const int hm_encode)
{
	vector<int> encode_list = this->getEncodingList();
